...
class IntroViewPageAdapter(private val mContext: Context, val screenArrayList: ArrayList<ScreenItem> ) : RecyclerView.Adapter<IntroViewPageAdapter.PageHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IntroViewPageAdapter.PageHolder {
        return PageHolder(
    ...
    override fun onBindViewHolder(holder: IntroViewPageAdapter.PageHolder, position: Int) {
